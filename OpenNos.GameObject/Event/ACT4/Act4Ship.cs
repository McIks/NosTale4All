...
namespace OpenNos.GameObject.Event
{
    ...
    public class Act4ShipThread
    {
        ...
        private void lockShip() => EventHelper.Instance.RunEvent(new EventContainer(ServerManager.Instance.GetMapInstance(ServerManager.Instance.GetBaseMapInstanceIdByMapId(261)), EventActionType.NPCSEFFECTCHANGESTATE, true));

        private void openShip() => EventHelper.Instance.RunEvent(new EventContainer(ServerManager.Instance.GetMapInstance(ServerManager.Instance.GetBaseMapInstanceIdByMapId(261)), EventActionType.NPCSEFFECTCHANGESTATE, false));
